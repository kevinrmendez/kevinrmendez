...
const Portfolio = React.createClass({
    ...
    <div className="section section1 group">
        <div className="col ">
        <h1> treenataanko.store</h1>
        <a href="https://treenataanko.store"><img src="assets/img/treenataankostore_logo.png" alt="treenataanko logo"/></a>
         ...
         <div className="col ">
        <h1> unitour</h1>
        <a href="http://unitour.000webhostapp.com"><img src="assets/img/unitour_logo.PNG" alt="unitour logo"/></a>
          <p className="project-description"> 
         ...
         <div className="col ">
        <h1> mrssantasite</h1>
        <a href="http://www.mrssantasite.com"><img src="assets/img/mrssantasite_logo.PNG" alt="mrssantasite logo"/></a>
          <p className="project-description"> 
